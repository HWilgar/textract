...
var _copyWPng = require("./img/copy-w.png");
var _copyWPngDefault = parcelHelpers.interopDefault(_copyWPng);
var _downloadW2Png = require("./img/download-w2.png");
var _downloadW2PngDefault = parcelHelpers.interopDefault(_downloadW2Png);
var _expandArrowsWPng = require("./img/expand-arrows-w.png");
var _expandArrowsWPngDefault = parcelHelpers.interopDefault(_expandArrowsWPng);
var _minimizeArrowsWPng = require("./img/minimize-arrows-w.png");
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function copyAllBtn(id) {
        ...
        copyImg.src = (0, _copyWPngDefault.default);
    ...
    function downloadBtn(id) {
        ...
        downloadImg.src = (0, _downloadW2PngDefault.default);
    ...
    function expandBtn(id) {
        ...
        expandImg.src = (0, _expandArrowsWPngDefault.default);
    ...
    function expandTextArea(id) {
        ...
        if (textarea.scrollHeight <= textarea.clientHeight && textarea.scrollHeight <= 70) return;
            ...
            img.src = (0, _minimizeArrowsWPngDefault.default);
            tooltip.textContent = "Minimize";
        } else {
            textarea.style.height = "70px";
            img.src = (0, _expandArrowsWPngDefault.default);
    ...
    function removeBtn(id) {
        ...
        removeImg.src = (0, _closeWPngDefault.default);
...
},{}],"bSBk7":[function(require,module,exports) {
module.exports = require("5f69217e65aea4fe").getBundleURL("fqV6O") + "download-w2.dbe84847.png" + "?" + Date.now();

},{"5f69217e65aea4fe":"lgJ39"}],"gQaSq":[function(require,module,exports) {
module.exports = require("27aff0670059897").getBundleURL("fqV6O") + "expand-arrows-w.ba2026b5.png" + "?" + Date.now();

},{"27aff0670059897":"lgJ39"}],"jHHk2":[function(require,module,exports) {
module.exports = require("9a829429b58d6f87").getBundleURL("fqV6O") + "minimize-arrows-w.88bbce01.png" + "?" + Date.now();

},{"9a829429b58d6f87":"lgJ39"}],"d8xlR":[function(require,module,exports) {
module.exports = require("fb963571162d6689").getBundleURL("fqV6O") + "close-w.9885f271.png" + "?" + Date.now();

},{"fb963571162d6689":"lgJ39"}],"gkKU3":[function(require,module,exports) {
